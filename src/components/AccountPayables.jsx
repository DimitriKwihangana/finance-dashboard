    ...
    <div className=" ">
      ...
      <main className="">
        <div className="bg-white rounded-lg shadow-lg p-4">
          <h2 className="text-xl font-bold mb-4 text-[#087abc]  text-center">ACCOUNT  PAYABLES AGEING SUMMARY AS OF <span className="underline underline-offset-8">{formattedDate}</span>
</h2>
          ...
          <table className="table-auto w-full border-collapse border border-gray-300">
            <thead>
              ...
              <th className="px-6 py-3 bg-[#087ABC] text-left text-xs font-semibold text-white uppercase tracking-wider">Supplier Name</th>
...
{showEditModal && (
  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
    <div className="bg-white rounded-lg shadow-lg w-1/3 p-6">
      <h3 className="text-xl font-bold mb-4">Edit Account Payable</h3>
...
{showReadOnlyModal && (
  <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
    <div className="bg-white rounded-lg shadow-lg w-1/3 p-6">
      <h3 className="text-xl font-bold mb-4">View Account Payable</h3>
      <div className="mb-4">
